...
public class CashRegister {
    ...
    public static void inputProducts() {
        while (true) {
            System.out.print("Product Name ('done' to pay, 'delete' to remove, 'update' to edit quantity): ");
    ...
    public static void updateProductQuantity() {
        ...
        String productToUpdate = scan.nextLine();
        int index = productNames.indexOf(productToUpdate);
        ...
        if (index != -1) {
            try {
                ...
                System.out.println("Quantity updated successfully for " + productToUpdate + ".");
            } catch (NumberFormatException e) {
